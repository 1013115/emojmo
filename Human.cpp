...
;
    ...
    glRotatef(50, -1, 0, 0); // x축 기준으로 추가로 30도 회전
    gluCylinder(quadric, baseRadius, topRadius, 1.0, 30, 20);
   
    glTranslatef(0, 0, height-0.14);
...
void draw() {
    ...
    drawRightArm(0.17, 0.17, 1.2, 1.0, 3.0, 0.0, 0);
    drawLeftArm(0.17, 0.17, 1.2, 1.0, 3.0, 0.0, 0);
